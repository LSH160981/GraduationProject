...
<template>
  ...
  <div ref="ChatInput" class="w-full flex flex-col justify-between">
    ...
    <div class="flex justify-start gap-2 md:mt-1 md:ml-2">
      ...
      <el-tooltip class="box-item" effect="dark" content="对话的顶部" placement="top-start">
        <el-button link>
          <svg
            t="1707142564589"
            class="icon"
            ...
            height="24">
            <path
              d="M886.6 649.4l-352-352c-12.5-12.5-32.8-12.5-45.3 0l-352 352c-6.2 6.2-9.4 14.4-9.4 22.6s3.1 16.4 9.4 22.6c12.5 12.5 32.8 12.5 45.3 0L512 365.3l329.4 329.4c12.5 12.5 32.8 12.5 45.3 0 12.4-12.6 12.4-32.8-0.1-45.3z"
              fill="#53b1e2"
              p-id="5163"></path>
          </svg>
        </el-button>
      </el-tooltip>
      <el-tooltip class="box-item" effect="dark" content="对话的底部" placement="top-start">
        <el-button link>
          <svg
            t="1707142628735"
            class="icon"
            ...
            height="24">
            <path
              d="M137.4 374.6l352 352c12.5 12.5 32.8 12.5 45.3 0l352-352c6.2-6.2 9.4-14.4 9.4-22.6s-3.1-16.4-9.4-22.6c-12.5-12.5-32.8-12.5-45.3 0L512 658.7 182.6 329.4c-12.5-12.5-32.8-12.5-45.3 0-12.4 12.5-12.4 32.7 0.1 45.2z"
              fill="#53b1e2"
              p-id="6278"></path>
          </svg>
        </el-button>
